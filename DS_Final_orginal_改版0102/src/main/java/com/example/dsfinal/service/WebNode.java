...
public class WebNode
{
	...
	public void setNodeScore(ArrayList<Keyword> keywords, KeywordWeights keywordWeights) throws IOException{
		// YOUR TURN
		...
		webPage.setScore(keywords, keywordWeights);
		nodeScore = webPage.score;
		
		for(WebNode child : children) {
			child.setNodeScore(keywords, keywordWeights);
